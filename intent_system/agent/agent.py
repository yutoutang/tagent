...
from intent_system.agent.graph import create_unified_agent_graph, create_default_components
...
class UnifiedAgent:
    ...
    def __init__(
        ...
        # 创建计算图
        self.app = create_unified_agent_graph(
            llm=self.llm,
    ...
    def get_graph_description(self) -> str:
        ...
        Returns:
            Mermaid 格式的图描述
        """
        from intent_system.agent.graph import visualize_graph
